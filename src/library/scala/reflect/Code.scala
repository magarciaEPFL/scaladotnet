...
@deprecated("Replaced with scala.reflect.macro.Context#reify, will be completely removed soon", "2.10.0")
...
object Code {
  def lift[A](tree: A): Code[A] =
    throw new java.lang.Error("Code was not lifted by compiler")
}
