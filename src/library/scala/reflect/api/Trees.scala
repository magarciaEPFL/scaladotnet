...
trait Trees { self: Universe =>
  ...
  abstract class Tree extends Product {
    ...
    def symbol_=(sym: Symbol) { throw new java.lang.UnsupportedOperationException("symbol_= inapplicable for " + this) }
    ...
    override def GetHashCode(): Int = java.lang.System.identityHashCode(this)
...
// ----- tree node alternatives --------------------------------------
  ...
  case object EmptyTree extends TermTree {
    ...
    override def tpe_=(t: Type) =
      if (t != NoType) throw new java.lang.UnsupportedOperationException("tpe_=("+t+") inapplicable for <empty>")
...
//  def Literal(x: Any) = new Literal(Constant(x))
  ...
  def copyDefDef(tree: Tree)(
    ...
    case t =>
      sys.error("Not a DefDef: " + t + "/" + _root_.java.lang.Object.instancehelper_getClass(t))
  }
  def copyValDef(tree: Tree)(
    ...
    case t =>
      sys.error("Not a ValDef: " + t + "/" + _root_.java.lang.Object.instancehelper_getClass(t))
  }
  def copyClassDef(tree: Tree)(
    ...
    case t =>
      sys.error("Not a ClassDef: " + t + "/" + _root_.java.lang.Object.instancehelper_getClass(t))
  }
  ...
  def deriveTemplate(templ: Tree)(applyToBody: List[Tree] => List[Tree]): Template = templ match {
    ...
    case t =>
      sys.error("Not a Template: " + t + "/" + _root_.java.lang.Object.instancehelper_getClass(t))
  }
  ...
  def deriveCaseDef(cdef: Tree)(applyToBody: Tree => Tree): CaseDef = cdef match {
    ...
    case t =>
      sys.error("Not a CaseDef: " + t + "/" + _root_.java.lang.Object.instancehelper_getClass(t))
  }
  def deriveLabelDef(ldef: Tree)(applyToRhs: Tree => Tree): LabelDef = ldef match {
    ...
    case t =>
      sys.error("Not a LabelDef: " + t + "/" + _root_.java.lang.Object.instancehelper_getClass(t))
  }
