...
trait Ordering[T] extends Comparator/*[T]*/ with PartialOrdering[T] with Serializable {
 ...
 /** Returns an integer whose sign communicates how x compares to y.
   ...
   */
  def compareNonErased(x: T, y: T): Int
  override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[T], y.asInstanceOf[T]) }
  ...
  override def reverse: Ordering[T] = new Ordering[T] {
    ...
    def compareNonErased(x: T, y: T) = outer.compare(y, x)
    override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[T], y.asInstanceOf[T]) }
  }
  ...
  def on[U](f: U => T): Ordering[U] = new Ordering[U] {
    def compareNonErased(x: U, y: U) = outer.compare(f(x), f(y))
    override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[U], y.asInstanceOf[U]) }
  }
...
trait LowPriorityOrderingImplicits {
   ...
   */
  implicit def ordered[A <% java.lang.Comparable/*[A]*/]: Ordering[A] = new Ordering[A] {
    def compareNonErased(x: A, y: A): Int = java.lang.Comparable.__Helper.compareTo(x, y)
    override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[A], y.asInstanceOf[A]) }
  }
  implicit def comparatorToOrdering[A](implicit cmp: Comparator/*[A]*/): Ordering[A] = new Ordering[A] {
    def compareNonErased(x: A, y: A) = cmp.compare(x, y)
    override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[A], y.asInstanceOf[A]) }
  }
}
...
object Ordering extends LowPriorityOrderingImplicits {
  ...
  trait ExtraImplicits {
    ...
    implicit def seqDerivedOrdering[CC[X] <: collection.Seq[X], T](implicit ord: Ordering[T]): Ordering[CC[T]] =
      new Ordering[CC[T]] {
        def compareNonErased(x: CC[T], y: CC[T]): Int = {
          val xe = x.iterator
          val ye = y.iterator
        ...
        override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
        override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[CC[T]], y.asInstanceOf[CC[T]]) }
      }
  ...
  def fromLessThan[T](cmp: (T, T) => Boolean): Ordering[T] = new Ordering[T] {
    def compareNonErased(x: T, y: T) = if (cmp(x, y)) -1 else if (cmp(y, x)) 1 else 0
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[T], y.asInstanceOf[T]) }
  ...
  trait UnitOrdering extends Ordering[Unit] {
    def compareNonErased(x: Unit, y: Unit) = 0
    override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[Unit], y.asInstanceOf[Unit]) }
  }
  implicit object Unit extends UnitOrdering

  trait BooleanOrdering extends Ordering[Boolean] {
    def compareNonErased(x: Boolean, y: Boolean) = (x, y) match {
      case (false, true) => -1
      case (true, false) => 1
      case _ => 0
    }
    override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[Boolean], y.asInstanceOf[Boolean]) }
  }
  implicit object Boolean extends BooleanOrdering

  trait ByteOrdering extends Ordering[Byte] {
    def compareNonErased(x: Byte, y: Byte) = x.toInt - y.toInt
    override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[Byte], y.asInstanceOf[Byte]) }
  }
  implicit object Byte extends ByteOrdering

  trait CharOrdering extends Ordering[Char] {
    def compareNonErased(x: Char, y: Char) = x.toInt - y.toInt
    override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[Char], y.asInstanceOf[Char]) }
  }
  implicit object Char extends CharOrdering

  trait ShortOrdering extends Ordering[Short] {
    def compareNonErased(x: Short, y: Short) = x.toInt - y.toInt
    override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[Short], y.asInstanceOf[Short]) }
  }
  implicit object Short extends ShortOrdering

  trait IntOrdering extends Ordering[Int] {
    def compareNonErased(x: Int, y: Int) =
      if (x < y) -1
      else if (x == y) 0
      else 1
    override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[Int], y.asInstanceOf[Int]) }
  }
  implicit object Int extends IntOrdering

  trait LongOrdering extends Ordering[Long] {
    def compareNonErased(x: Long, y: Long) =
      if (x < y) -1
      else if (x == y) 0
      else 1
    override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[Long], y.asInstanceOf[Long]) }
  }
  ...
  trait FloatOrdering extends Ordering[Float] {
    ...
    def compareNonErased(x: Float, y: Float) = java.lang.Float.compare(x, y)
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[Float], y.asInstanceOf[Float]) }
    ...
    override def reverse: Ordering[Float] = new FloatOrdering {
      override def reverse = outer
      override def compareNonErased(x: Float, y: Float) = outer.compare(y, x)
      override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[Float], y.asInstanceOf[Float]) }
  ...
  trait DoubleOrdering extends Ordering[Double] {
    ...
    def compareNonErased(x: Double, y: Double) = java.lang.Double.compare(x, y)
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[Double], y.asInstanceOf[Double]) }
    ...
    override def reverse: Ordering[Double] = new DoubleOrdering {
      override def reverse = outer
      override def compareNonErased(x: Double, y: Double) = outer.compare(y, x)
      override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[Double], y.asInstanceOf[Double]) }
  ...
  trait BigIntOrdering extends Ordering[BigInt] {
    def compareNonErased(x: BigInt, y: BigInt) = x.compare(y)
    override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[BigInt], y.asInstanceOf[BigInt]) }
  }
  implicit object BigInt extends BigIntOrdering

  trait BigDecimalOrdering extends Ordering[BigDecimal] {
    def compareNonErased(x: BigDecimal, y: BigDecimal) = x.compare(y)
    override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[BigDecimal], y.asInstanceOf[BigDecimal]) }
  }
  implicit object BigDecimal extends BigDecimalOrdering

  trait StringOrdering extends Ordering[String] {
    def compareNonErased(x: String, y: String) = _root_.java.lang.String.instancehelper_compareTo(x, y)
    override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[String], y.asInstanceOf[String]) }
  }
  implicit object String extends StringOrdering

  trait OptionOrdering[T] extends Ordering[Option[T]] {
    def optionOrdering: Ordering[T]
    def compareNonErased(x: Option[T], y: Option[T]) = (x, y) match {
      case (None, None)       => 0
      case (None, _)          => -1
      case (_, None)          => 1
    ...
    override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
    override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[Option[T]], y.asInstanceOf[Option[T]]) }
  }
  ...
  implicit def Iterable[T](implicit ord: Ordering[T]): Ordering[Iterable[T]] =
    new Ordering[Iterable[T]] {
      def compareNonErased(x: Iterable[T], y: Iterable[T]): Int = {
        val xe = x.iterator
        val ye = y.iterator
      ...
      override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
      override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[Iterable[T]], y.asInstanceOf[Iterable[T]]) }
    }

  implicit def Tuple2[T1, T2](implicit ord1: Ordering[T1], ord2: Ordering[T2]): Ordering[(T1, T2)] =
    new Ordering[(T1, T2)]{
      def compareNonErased(x: (T1, T2), y: (T1, T2)): Int = {
      ...
      override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
      override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[(T1, T2)], y.asInstanceOf[(T1, T2)]) }
    }
  ...
  implicit def Tuple3[T1, T2, T3](implicit ord1: Ordering[T1], ord2: Ordering[T2], ord3: Ordering[T3]) : Ordering[(T1, T2, T3)] =
    new Ordering[(T1, T2, T3)]{
      def compareNonErased(x: (T1, T2, T3), y: (T1, T2, T3)): Int = {
        val compare1 = ord1.compare(x._1, y._1)
        if (compare1 != 0) return compare1
        val compare2 = ord2.compare(x._2, y._2)
        if (compare2 != 0) return compare2
      ...
      override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
      override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[(T1, T2, T3)], y.asInstanceOf[(T1, T2, T3)]) }
    }
  ...
  implicit def Tuple4[T1, T2, T3, T4](implicit ord1: Ordering[T1], ord2: Ordering[T2], ord3: Ordering[T3], ord4: Ordering[T4]) : Ordering[(T1, T2, T3, T4)] =
    new Ordering[(T1, T2, T3, T4)]{
      def compareNonErased(x: (T1, T2, T3, T4), y: (T1, T2, T3, T4)): Int = {
        val compare1 = ord1.compare(x._1, y._1)
        if (compare1 != 0) return compare1
        val compare2 = ord2.compare(x._2, y._2)
        if (compare2 != 0) return compare2
      ...
      override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
      override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[(T1, T2, T3, T4)], y.asInstanceOf[(T1, T2, T3, T4)]) }
    }

  implicit def Tuple5[T1, T2, T3, T4, T5](implicit ord1: Ordering[T1], ord2: Ordering[T2], ord3: Ordering[T3], ord4: Ordering[T4], ord5: Ordering[T5]): Ordering[(T1, T2, T3, T4, T5)] =
    new Ordering[(T1, T2, T3, T4, T5)]{
      def compareNonErased(x: (T1, T2, T3, T4, T5), y: Tuple5[T1, T2, T3, T4, T5]): Int = {
        val compare1 = ord1.compare(x._1, y._1)
        if (compare1 != 0) return compare1
        val compare2 = ord2.compare(x._2, y._2)
        if (compare2 != 0) return compare2
      ...
      override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
      override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[(T1, T2, T3, T4, T5)], y.asInstanceOf[Tuple5[T1, T2, T3, T4, T5]]) }
    }
  ...
  implicit def Tuple6[T1, T2, T3, T4, T5, T6](implicit ord1: Ordering[T1], ord2: Ordering[T2], ord3: Ordering[T3], ord4: Ordering[T4], ord5: Ordering[T5], ord6: Ordering[T6]): Ordering[(T1, T2, T3, T4, T5, T6)] =
    new Ordering[(T1, T2, T3, T4, T5, T6)]{
      def compareNonErased(x: (T1, T2, T3, T4, T5, T6), y: (T1, T2, T3, T4, T5, T6)): Int = {
        val compare1 = ord1.compare(x._1, y._1)
        if (compare1 != 0) return compare1
        val compare2 = ord2.compare(x._2, y._2)
        if (compare2 != 0) return compare2
      ...
      override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
      override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[(T1, T2, T3, T4, T5, T6)], y.asInstanceOf[(T1, T2, T3, T4, T5, T6)]) }
    }
  ...
  implicit def Tuple7[T1, T2, T3, T4, T5, T6, T7](implicit ord1: Ordering[T1], ord2: Ordering[T2], ord3: Ordering[T3], ord4: Ordering[T4], ord5: Ordering[T5], ord6: Ordering[T6], ord7: Ordering[T7]): Ordering[(T1, T2, T3, T4, T5, T6, T7)] =
    new Ordering[(T1, T2, T3, T4, T5, T6, T7)]{
      def compareNonErased(x: (T1, T2, T3, T4, T5, T6, T7), y: (T1, T2, T3, T4, T5, T6, T7)): Int = {
        val compare1 = ord1.compare(x._1, y._1)
        if (compare1 != 0) return compare1
        val compare2 = ord2.compare(x._2, y._2)
        if (compare2 != 0) return compare2
      ...
      override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
      override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[(T1, T2, T3, T4, T5, T6, T7)], y.asInstanceOf[(T1, T2, T3, T4, T5, T6, T7)]) }
    }
  ...
  implicit def Tuple8[T1, T2, T3, T4, T5, T6, T7, T8](implicit ord1: Ordering[T1], ord2: Ordering[T2], ord3: Ordering[T3], ord4: Ordering[T4], ord5: Ordering[T5], ord6: Ordering[T6], ord7: Ordering[T7], ord8: Ordering[T8]): Ordering[(T1, T2, T3, T4, T5, T6, T7, T8)] =
    new Ordering[(T1, T2, T3, T4, T5, T6, T7, T8)]{
      def compareNonErased(x: (T1, T2, T3, T4, T5, T6, T7, T8), y: (T1, T2, T3, T4, T5, T6, T7, T8)): Int = {
        val compare1 = ord1.compare(x._1, y._1)
        if (compare1 != 0) return compare1
        val compare2 = ord2.compare(x._2, y._2)
        if (compare2 != 0) return compare2
      ...
      override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
      override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[(T1, T2, T3, T4, T5, T6, T7, T8)], y.asInstanceOf[(T1, T2, T3, T4, T5, T6, T7, T8)]) }
    }
  ...
  implicit def Tuple9[T1, T2, T3, T4, T5, T6, T7, T8, T9](implicit ord1: Ordering[T1], ord2: Ordering[T2], ord3: Ordering[T3], ord4: Ordering[T4], ord5: Ordering[T5], ord6: Ordering[T6], ord7: Ordering[T7], ord8 : Ordering[T8], ord9: Ordering[T9]): Ordering[(T1, T2, T3, T4, T5, T6, T7, T8, T9)] =
    new Ordering[(T1, T2, T3, T4, T5, T6, T7, T8, T9)]{
      def compareNonErased(x: (T1, T2, T3, T4, T5, T6, T7, T8, T9), y: (T1, T2, T3, T4, T5, T6, T7, T8, T9)): Int = {
        val compare1 = ord1.compare(x._1, y._1)
        if (compare1 != 0) return compare1
        val compare2 = ord2.compare(x._2, y._2)
        if (compare2 != 0) return compare2
      ...
      override def equals(that: Any) = { this.Equals(that) } /*addMissingJLObjOverrides*/ 
      override def compare(x: Any, y: Any) = { this.compareNonErased(x.asInstanceOf[(T1, T2, T3, T4, T5, T6, T7, T8, T9)], y.asInstanceOf[(T1, T2, T3, T4, T5, T6, T7, T8, T9)]) }
    }
