...
self =>
   ...
   *  $multipleCallbacks
   */
  def onFailure[U](callback: PartialFunction[System.Exception, U]): this.type = onComplete {
    ...
    onComplete {
      ...
      case Success(v) => 
        try {
          ...
          case t: System.Exception => p complete resolver(t)
        }
    }
   ...
   *  }}}
   */
  def recover[U >: T](pf: PartialFunction[System.Exception, U]): Future[U] = {
    val p = newPromise[U]
    
    onComplete {
      case Failure(t) if pf isDefinedAt t =>
        try { p success pf(t) }
        catch { case t: System.Exception => p complete resolver(t) }
   ...
   *  }}}
   */
  def recoverWith[U >: T](pf: PartialFunction[System.Exception, Future[U]]): Future[U] = {
    val p = newPromise[U]
