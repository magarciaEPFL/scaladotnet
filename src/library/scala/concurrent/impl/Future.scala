...
object Future {
  ...
  private val toBoxed = Map[Class/*[_]*/, Class/*[_]*/](
    type2class(classOf[Boolean]) -> type2class(classOf[jl.Boolean]),
    type2class(classOf[Byte])    -> type2class(classOf[jl.Byte]),
    type2class(classOf[Char])    -> type2class(classOf[jl.Character]),
    type2class(classOf[Short])   -> type2class(classOf[jl.Short]),
    type2class(classOf[Int])     -> type2class(classOf[jl.Integer]),
    type2class(classOf[Long])    -> type2class(classOf[jl.Long]),
    type2class(classOf[Float])   -> type2class(classOf[jl.Float]),
    type2class(classOf[Double])  -> type2class(classOf[jl.Double]),
    type2class(classOf[Unit])    -> type2class(classOf[scala.runtime.BoxedUnit])
  )
