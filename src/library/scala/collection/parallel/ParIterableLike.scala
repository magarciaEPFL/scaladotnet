...
self: ParIterableLike[T, Repr, Sequential] =>
  ...
  protected implicit def builder2ops[Elem, To](cb: Builder[Elem, To]) = new BuilderOps[Elem, To] {
    def ifIs[Cmb](isbody: Cmb => Unit) = new Otherwise[Cmb] {
      def otherwise(notbody: => Unit)(implicit m: ClassManifest[Cmb]) {
        if (_root_.java.lang.Object.instancehelper_getClass(cb) == m.erasure) isbody(cb.asInstanceOf[Cmb]) else notbody
      }
    }
  ...
  */
  ...
  def maxBy[S](f: T => S)(implicit cmp: Ordering[S]): T = {
    if (isEmpty) throw new java.lang.UnsupportedOperationException("empty.maxBy")

    reduce((x, y) => if (cmp.gteq(f(x), f(y))) x else y)
  }

  def minBy[S](f: T => S)(implicit cmp: Ordering[S]): T = {
    if (isEmpty) throw new java.lang.UnsupportedOperationException("empty.minBy")
  ...
  protected trait StrictSplitterCheckTask[R, Tp] extends Task[R, Tp] {
    ...
    if (requiresStrictSplitters && !isStrictSplitterCollection)
      throw new java.lang.UnsupportedOperationException("This collection does not provide strict splitters.")
  }
  ...
  extends StrictSplitterCheckTask[R, Tp] {
    ...
    override def ToString = _root_.java.lang.Object.instancehelper_getClass(this).getSimpleName + "(" + pit.ToString + ")(" + result + ")(supername: " + super.ToString + ")"
  }

  protected[this] trait NonDivisibleTask[R, Tp] extends StrictSplitterCheckTask[R, Tp] {
    def shouldSplitFurther = false
    def split = throw new java.lang.UnsupportedOperationException("Does not split.")
  }
  ...
  extends Transformer[Combiner[U, This], Take[U, This]] {
    ...
    protected[this] def newSubtask(p: IterableSplitter[T]) = throw new java.lang.UnsupportedOperationException
    override def split = {
      val pits = pit.split
  ...
  private[parallel] def debugInformation = "Parallel collection: " + _root_.java.lang.Object.instancehelper_getClass(this)
