...
//    self: EnvironmentPassingCombiner[T, Nothing] =>
    ...
    def result() = throw new java.lang.UnsupportedOperationException("ParIterableView.Combiner.result")
    def size = throw new java.lang.UnsupportedOperationException("ParIterableView.Combiner.size")
    def clear() {}
    def combine[N <: T, NewTo >: Nothing](other: Combiner[N, NewTo]) =
      throw new java.lang.UnsupportedOperationException("ParIterableView.Combiner.result")
  }
