...
package immutable {
  ...
  private[parallel] class Repetition[T](elem: T, val length: Int) extends ParSeq[T] {
    ...
    def apply(idx: Int) = if (0 <= idx && idx < length) elem else throw new java.lang.IndexOutOfBoundsException("" + idx)
    override def seq = throw new java.lang.UnsupportedOperationException
    def update(idx: Int, elem: T) = throw new java.lang.UnsupportedOperationException
