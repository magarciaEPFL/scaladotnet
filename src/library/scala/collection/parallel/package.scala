...
package object parallel {
  ...
  private[parallel] def unsupported = throw new java.lang.UnsupportedOperationException

  private[parallel] def unsupportedop(msg: String) = throw new java.lang.UnsupportedOperationException(msg)

  private[parallel] def outofbounds(idx: Int) = throw new java.lang.IndexOutOfBoundsException(idx.ToString)

  private[parallel] def getTaskSupport: TaskSupport =
    if (util.Properties.isJavaAtLeast("1.6")) {
      val vendor = util.Properties.javaVmVendor
      if ((_root_.java.lang.String.instancehelper_contains(vendor, "Oracle")) || (_root_.java.lang.String.instancehelper_contains(vendor, "Sun")) || (_root_.java.lang.String.instancehelper_contains(vendor, "Apple"))) new ForkJoinTaskSupport
  ...
  implicit def throwable2ops(self: System.Exception) = new ThrowableOps {
    def alongWith(that: System.Exception) = (self, that) match {
...
package parallel {
  ...
  trait ThrowableOps {
    def alongWith(that: System.Exception): System.Exception
  }
