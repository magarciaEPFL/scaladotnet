...
trait Tasks {
  ...
  trait Task[R, +Tp] {
    ...
    @volatile var throwable: System.Exception = null
...
trait ThreadPoolTasks extends Tasks {
  ...
  trait TaskImpl[R, +Tp] extends java.lang.Runnable with super.TaskImpl[R, Tp] {
    ...
    def sync() = synchronized {
      ...
      while (!completed) _root_.java.lang.Object.instancehelper_wait(this)
    }
  ...
  def queue = executor.getQueue.asInstanceOf[LinkedBlockingQueue/*[java.lang.Runnable]*/]
