    ...
    with CustomParallelizable[T, ParArray[T]]
{
  ...
  override def toArray[U >: T : ClassManifest]: Array[U] =
    if (implicitly[ClassManifest[U]].erasure eq _root_.java.lang.Object.instancehelper_getClass(array).getComponentType)
  ...
  override def MemberwiseClone: WrappedArray[T] = WrappedArray make array.Clone()
...
object WrappedArray {
  ...
  final class ofRef[T <: AnyRef](val array: Array[T]) extends WrappedArray[T] with Serializable {
    lazy val elemManifest = ClassManifest.classType[T](_root_.java.lang.Object.instancehelper_getClass(array).getComponentType)
