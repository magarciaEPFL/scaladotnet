...
final class StringBuilder(private val underlying: JavaStringBuilder)
      extends AbstractSeq[Char]
         with java.lang.CharSequence.__Interface /* MANUALLY */
  ...
  def append(x: Any): StringBuilder = {
    underlying append java.lang.String.valueOf(x)
    this
  }
   ...
   */
  def insert(index: Int, x: Any): StringBuilder = insert(index, java.lang.String.valueOf(x))
   ...
   *  @return       this StringBuilder.
   */
  def insert(index: Int, x: Boolean): StringBuilder = insert(index, java.lang.String.valueOf(x))
  def insert(index: Int, x: Byte): StringBuilder    = insert(index, java.lang.String.valueOf(x))
  def insert(index: Int, x: Short): StringBuilder   = insert(index, java.lang.String.valueOf(x))
  def insert(index: Int, x: Int): StringBuilder     = insert(index, java.lang.String.valueOf(x))
  def insert(index: Int, x: Long): StringBuilder    = insert(index, java.lang.String.valueOf(x))
  def insert(index: Int, x: Float): StringBuilder   = insert(index, java.lang.String.valueOf(x))
  def insert(index: Int, x: Double): StringBuilder  = insert(index, java.lang.String.valueOf(x))
  def insert(index: Int, x: Char): StringBuilder    = insert(index, java.lang.String.valueOf(x))
  ...
  override def reverse: StringBuilder = new StringBuilder(new java.lang.StringBuilder(underlying) reverse)

  override def MemberwiseClone(): StringBuilder = new StringBuilder(new java.lang.StringBuilder(underlying))
  ...
  override def toString() = { this.ToString() } /*addMissingJLObjOverrides*/ 
}
