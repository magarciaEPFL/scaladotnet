...
trait TraversableOnce[+A] extends GenTraversableOnce[A] {
  ...
  def reduceLeft[B >: A](op: (B, A) => B): B = {
    if (isEmpty)
      throw new java.lang.UnsupportedOperationException("empty.reduceLeft")
  ...
  def reduceRight[B >: A](op: (A, B) => B): B = {
    if (isEmpty)
      throw new java.lang.UnsupportedOperationException("empty.reduceRight")
  ...
  def min[B >: A](implicit cmp: Ordering[B]): A = {
    if (isEmpty)
      throw new java.lang.UnsupportedOperationException("empty.min")
  ...
  def max[B >: A](implicit cmp: Ordering[B]): A = {
    if (isEmpty)
      throw new java.lang.UnsupportedOperationException("empty.max")
  ...
  def maxBy[B](f: A => B)(implicit cmp: Ordering[B]): A = {
    if (isEmpty)
      throw new java.lang.UnsupportedOperationException("empty.maxBy")

    reduceLeft((x, y) => if (cmp.gteq(f(x), f(y))) x else y)
  }
  def minBy[B](f: A => B)(implicit cmp: Ordering[B]): A = {
    if (isEmpty)
      throw new java.lang.UnsupportedOperationException("empty.minBy")
