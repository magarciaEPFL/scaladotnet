...
package collection {
  ...
  private[collection] object DebugUtils {
    def unsupported(msg: String)     = throw new java.lang.UnsupportedOperationException(msg)
    def noSuchElement(msg: String)   = throw new NoSuchElementException(msg)
    def indexOutOfBounds(index: Int) = throw new java.lang.IndexOutOfBoundsException(index.ToString)
    def illegalArgument(msg: String) = throw new java.lang.IllegalArgumentException(msg)
