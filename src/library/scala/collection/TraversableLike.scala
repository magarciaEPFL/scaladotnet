                                    ...
                                    with Parallelizable[A, ParIterable[A]]
{
  ...
  def stringPrefix : String = {
    var string = _root_.java.lang.Object.instancehelper_getClass(repr.asInstanceOf[AnyRef]).getName
    val idx1 = string.LastIndexOf('.')
    if (idx1 != -1) string = string.Substring(idx1 + 1)
    val idx2 = string.IndexOf('$')
    if (idx2 != -1) string = _root_.java.lang.String.instancehelper_substring(string, 0, idx2)
    string
  }
