...
private[scala] trait PropertiesTrait {
  ...
  def propOrFalse(name: String)                 = propOrNone(name) exists (x => List("yes", "on", "true") contains x.ToLower)
  def setProp(name: String, value: String)      = java.lang.System.setProperty(name, value)
  def clearProp(name: String)                   = java.lang.System.clearProperty(name)

  def envOrElse(name: String, alt: String)      = Option(java.lang.System getenv name) getOrElse alt
  def envOrNone(name: String)                   = Option(java.lang.System getenv name)
