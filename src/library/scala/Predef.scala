...
object Predef extends LowPriorityImplicits {
  ...
  type String        = System.String /* MANUAL EDIT */ 
  ...
  def require(requirement: Boolean) {
    if (!requirement)
      throw new java.lang.IllegalArgumentException("requirement failed")
  }
  ...
  @inline final def require(requirement: Boolean, message: => Any) {
    if (!requirement)
      throw new java.lang.IllegalArgumentException("requirement failed: "+ message)
  }
  ...
  implicit def exceptionWrapper(exc: System.Exception) = new runtime.RichException(exc)
  ...
  implicit def seqToCharSequence(xs: collection.IndexedSeq[Char]): java.lang.CharSequence = {
    val w = new java.lang.CharSequence.__Interface { /* MANUAL EDIT */
  ...
  /* implicits added because IKVM says so  */
