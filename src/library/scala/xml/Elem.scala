...
extends Node with Serializable
{
  ...
  if (prefix == "")
    throw new java.lang.IllegalArgumentException("prefix of zero length, use null instead")

  if (scope == null)
    throw new java.lang.IllegalArgumentException("scope is null, use xml.TopScope for empty scope")
