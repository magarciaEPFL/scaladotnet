...
object Array extends FallbackArrayBuilding {
  ...
  def copy(src: AnyRef, srcPos: Int, dest: AnyRef, destPos: Int, length: Int) {
    val srcClass = _root_.java.lang.Object.instancehelper_getClass(src)
    if (srcClass.isArray && _root_.java.lang.Object.instancehelper_getClass(dest).isAssignableFrom(srcClass))
  ...
  def range(start: Int, end: Int, step: Int): Array[Int] = {
    if (step == 0) throw new java.lang.IllegalArgumentException("zero step")
 ...
 */
final class Array[T](_length: Int) extends java.io.Serializable.__Interface with java.lang.Cloneable.__Interface {

  /** The length of the array */
  def length: Int = throw new java.lang.Error()
   ...
   */
  def apply(i: Int): T = throw new java.lang.Error()
   ...
   *  @throws       ArrayIndexOutOfBoundsException if `i < 0` or `length <= i`
   */
  def update(i: Int, x: T) { throw new java.lang.Error() }

  /** Clone the Array.
   *
   *  @return A clone of the Array.
   */
  override def MemberwiseClone: Array[T] = throw new java.lang.Error() /* MANUAL EDIT */
}
