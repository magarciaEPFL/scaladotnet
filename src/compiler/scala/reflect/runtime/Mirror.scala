...
class Mirror extends Universe with RuntimeTypes with TreeBuildUtil with ToolBoxes with api.Mirror {
  ...
  def getClass(obj: AnyRef): Symbol = classToScala(_root_.java.lang.Object.instancehelper_getClass(obj))
  def getType(obj: AnyRef): Type = typeToScala(_root_.java.lang.Object.instancehelper_getClass(obj))
  ...
  def invoke(receiver: AnyRef, meth: Symbol, args: Any*): Any = {
    ...
    methodToJava(meth).invoke(receiver, scala.Array( args.asInstanceOf[Seq[AnyRef]]: _* ) )
  }
