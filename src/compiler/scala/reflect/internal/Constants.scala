...
trait Constants extends api.Constants {
  ...
  case class Constant(value: Any) extends AbsConstant {
    val tag: Int = value match {
      ...
      case _            => throw new java.lang.Error("bad constant value: " + value + " of class " + value.GetType)
    }
    ...
    def booleanValue: Boolean =
      ...
      else throw new java.lang.Error("value " + value + " is not a boolean");
    ...
    def byteValue: Byte = tag match {
      ...
      case _         => throw new java.lang.Error("value " + value + " is not a Byte")
    }
    ...
    def shortValue: Short = tag match {
      ...
      case _         => throw new java.lang.Error("value " + value + " is not a Short")
    }
    ...
    def charValue: Char = tag match {
      ...
      case _         => throw new java.lang.Error("value " + value + " is not a Char")
    }
    ...
    def intValue: Int = tag match {
      ...
      case _         => throw new java.lang.Error("value " + value + " is not an Int")
    }
    ...
    def longValue: Long = tag match {
      ...
      case _         => throw new java.lang.Error("value " + value + " is not a Long")
    }
    ...
    def floatValue: Float = tag match {
      ...
      case _         => throw new java.lang.Error("value " + value + " is not a Float")
    }
    ...
    def doubleValue: Double = tag match {
      ...
      case _         => throw new java.lang.Error("value " + value + " is not a Double")
    }
    ...
    @switch def escapedChar(ch: Char): String = ch match {
      ...
      case '\'' => "\\\'"
      case '\\' => "\\\\"
      case _    => if (ch.isControl) "\\0" + java.lang.Integer.toOctalString(ch) else java.lang.String.valueOf(ch)
    }
    ...
    override def GetHashCode: Int = value.## * 41 + 17
  }
