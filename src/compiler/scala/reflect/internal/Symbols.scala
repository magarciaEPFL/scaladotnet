...
// ------ flags attribute --------------------------------------------------------------
    ...
    final def flags: Long = {
      ...
      (fs | ((fs & LateFlags) >>> ((LateShift) & 0x3f))) & ~(fs >>> ((AntiShift) & 0x3f))
    }
...
// ----- setters implemented in selected subclasses -------------------------------------
    ...
    def typeOfThis_=(tp: Type)       { throw new java.lang.UnsupportedOperationException("typeOfThis_= inapplicable for " + this) }
    def sourceModule_=(sym: Symbol)  { throw new java.lang.UnsupportedOperationException("sourceModule_= inapplicable for " + this) }
    def addChild(sym: Symbol)        { throw new java.lang.UnsupportedOperationException("addChild inapplicable for " + this) }
...
// ------ toString -------------------------------------------------------------------
  ...
  case class InvalidCompanions(sym1: Symbol, sym2: Symbol) extends java.lang.Throwable(
