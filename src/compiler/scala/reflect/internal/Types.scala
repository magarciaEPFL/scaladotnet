...
trait Types extends api.Types { self: SymbolTable =>
  ...
  case object UnmappableTree extends TermTree {
    ...
    super.tpe_=(NoType)
    override def tpe_=(t: Type) = if (t != NoType) throw new java.lang.UnsupportedOperationException("tpe_=("+t+") inapplicable for <empty>")
  }
...
//        scala.tools.nsc.util.trace.when(pre.isInstanceOf[ExistentialType])("X "+this+".asSeenfrom("+pre+","+clazz+" = ") {
   ...
   /** Convert toString avoiding infinite recursions by cutting off
    ...
    def kind: String = "unknown type of class "+_root_.java.lang.Object.instancehelper_getClass(this)
  }

// Subclasses ------------------------------------------------------------

  trait UniqueType extends Product {
    final override val GetHashCode = scala.runtime.ScalaRunTime._hashCode(this)
  }
...
*/
  ...
  abstract case class SuperType(thistpe: Type, supertpe: Type) extends SingletonType {
    ...
    override def prefixString = _root_.java.lang.String.instancehelper_replaceAll(thistpe.prefixString, """\bthis\.$""", "super.")
  ...
  object TypeVar {
    ...
    def apply(origin: Type, constr: TypeConstraint, args: List[Type], params: List[Symbol]): TypeVar = {
      val tv = (
        ...
        else throw new java.lang.Error("Invalid TypeVar construction: " + ((origin, constr, args, params)))
      )
  ...
  class TypeVar(
    ...
    def applyArgs(newArgs: List[Type]): TypeVar = (
      if (newArgs.isEmpty && typeArgs.isEmpty)
        ...
        throw new java.lang.Error("Invalid type application in TypeVar: " + params + ", " + newArgs)
    )
...
//      assert(!(tp containsTp this), this)
    ...
    def originName = {
      ...
      if (_root_.java.lang.String.instancehelper_contains(name, "_$")) origin.typeSymbolDirect.decodedName else name
    }
    def originLocation = {
                      ...
                      if (ps.isEmpty) {
                        if (forInteractive) {
                          ...
                          try {
                            ...
                            println("*** stacktrace = ")
                            java.lang.Throwable.instancehelper_printStackTrace(new java.lang.Error())
...
// dependent method types
  ...
  class SubTypePair(val tp1: Type, val tp2: Type) {
    override def GetHashCode = tp1.GetHashCode * 41 + tp2.GetHashCode
...
// Lubs and Glbs ---------------------------------------------------------
  ...
  private def printLubMatrix(btsMap: Map[Type, List[Type]], depth: Int) {
    ...
    def str(tp: Type) = {
      if (tp == NoType) ""
        ...
        val s = _root_.java.lang.String.instancehelper_replaceAll("" + tp, """[\w.]+\.(\w+)""", "$1")
        if (s.Length < 60) s
        else (s take 57) + "..."
      }
    }
  ...
  val GlbFailure = new java.lang.Throwable
...
// Errors and Diagnostics -----------------------------------------------------
  ...
  class TypeError(var pos: Position, val msg: String) extends java.lang.Throwable(msg) {
  ...
  class NoCommonType(tps: List[Type]) extends java.lang.Throwable(
