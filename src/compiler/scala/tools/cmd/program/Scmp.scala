...
object Scmp {
  ...
  def main(args0: Array[String]): Unit = {
    ...
    if (_root_.java.lang.String.instancehelper_isEmpty(p1args) && _root_.java.lang.String.instancehelper_isEmpty(p2args))
    ...
    if (_root_.java.lang.String.instancehelper_isEmpty(diff)) println("No differences.")
    else println(diff)
  }
}
