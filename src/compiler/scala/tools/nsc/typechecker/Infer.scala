...
/* -- Type parameter inference utility functions --------------------------- */
  ...
  private class NoInstance(msg: String) extends java.lang.Throwable(msg) with ControlThrowable { }
  private class DeferredNoInstance(getmsg: () => String) extends NoInstance("") {
    override def getMessage(): String = getmsg()
  }
  private def ifNoInstance[T](f: String => T): PartialFunction[System.Exception, T] = {
    case x: NoInstance  => f(x.Message)
  }
