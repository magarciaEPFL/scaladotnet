...
trait Macros { self: Analyzer =>
  ...
  lazy val mirror = new scala.reflect.runtime.Mirror {
    lazy val libraryClassLoader = {
      ...
      ScalaClassLoader.fromURLs(classpath, _root_.java.lang.Object.instancehelper_getClass(self).getClassLoader)
    }

    override def defaultReflectiveClassLoader() = libraryClassLoader
  }

  class MacroExpandError(val msg: String) extends java.lang.Exception(msg)
      ...
      case Some((receiver, rmeth)) =>
        ...
        try {
          ...
          case ex =>
            ...
            val msg = java.lang.System.getProperty("line.separator") + stacktrace
