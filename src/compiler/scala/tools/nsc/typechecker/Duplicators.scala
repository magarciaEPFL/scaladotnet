...
//          assert(sym1 ne NoSymbol, tpe)
      ...
      tpe match {
        case MethodType(_, res) =>
          res + ", " + res.bounds.hi + ", " + (res.bounds.hi match {
            ...
            case _ => "non-tref: " + _root_.java.lang.Object.instancehelper_getClass(res.bounds.hi)
          })
        case _ =>
      }
    }
    ...
    override def typed(tree: Tree, mode: Int, pt: Type): Tree = {
      debuglog("typing " + tree + ": " + tree.tpe + ", " + _root_.java.lang.Object.instancehelper_getClass(tree))
