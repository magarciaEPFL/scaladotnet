...
class StandardCompileServer extends SocketServer {
  ...
  def session() {
    ...
    val args        = _root_.java.lang.String.instancehelper_split(input, "\0", -1).toList
...
object CompileServer extends StandardCompileServer {
  ...
  def main(args: Array[String]) {
    ...
    redirect(java.lang.System.setOut, "scala-compile-server-out.log")
    redirect(java.lang.System.setErr, "scala-compile-server-err.log")
    java.lang.System.err.println("...starting server on socket "+port+"...")
