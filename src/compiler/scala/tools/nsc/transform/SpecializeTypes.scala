...
abstract class SpecializeTypes extends InfoTransform with TypingTransformers {
  ...
  private def unify(tp1: Type, tp2: Type, env: TypeEnv, strict: Boolean): TypeEnv = (tp1, tp2) match {
    ...
    case _ =>
      debuglog("don't know how to unify %s [%s] with %s [%s]".format(tp1, _root_.java.lang.Object.instancehelper_getClass(tp1), tp2, _root_.java.lang.Object.instancehelper_getClass(tp2)))
      env
  }
