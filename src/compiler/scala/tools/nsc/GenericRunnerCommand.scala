...
extends CompilerCommand(args, settings) {
  ...
  private def interpolate(s: String) = _root_.java.lang.String.instancehelper_replaceAll(_root_.java.lang.String.instancehelper_replaceAll(s.Trim, "@cmd@", cmdName), "@compileCmd@", compCmdName) + "\n"
