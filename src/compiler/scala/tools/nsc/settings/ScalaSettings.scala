...
trait ScalaSettings extends AbsScalaSettings
  ...
  val assemname     = StringSetting     ("-Xassem-name", "file", "Name of the output assembly.", "")
  val assemrefs     = StringSetting     ("-Xassem-path", "path", "List of assemblies referenced by the program.", ".")
  val assemextdirs  = StringSetting     ("-Xassem-extdirs", "dirs", "List of directories containing assemblies.  default: current folder", "." /* Defaults.scalaLibDir.path */ )
  val sourcedir     = StringSetting     ("-Xsourcedir", "directory", "Mirror source folder structure in output directory.", ".")
