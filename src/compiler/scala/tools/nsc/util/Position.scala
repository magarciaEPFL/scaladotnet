...
trait Position {
   ...
   *  None if not defined.
   */
  def source: SourceFile = throw new java.lang.UnsupportedOperationException("Position.source")
  ...
  def start: Int = throw new java.lang.UnsupportedOperationException("Position.start")

  /** The start of the position's range, or point if not a range position */
  def startOrPoint: Int = point

  /**  The point (where the ^ is) of the position */
  def point: Int = throw new java.lang.UnsupportedOperationException("Position.point")

  /**  The point (where the ^ is) of the position, or else `default` if undefined */
  def pointOrElse(default: Int): Int = default

  /** The end of the position's range, error if not a range position */
  def end: Int = throw new java.lang.UnsupportedOperationException("Position.end")
  ...
  def line: Int = throw new java.lang.UnsupportedOperationException("Position.line")

  def column: Int = throw new java.lang.UnsupportedOperationException("Position.column")
...
class OffsetPosition(override val source: SourceFile, override val point: Int) extends Position {
  ...
  override def GetHashCode = point * 37 + source.file.GetHashCode
