...
object JarRunner extends CommonRunner {
  def runJar(settings: GenericRunnerSettings, jarPath: String, arguments: Seq[String]): Either[System.Exception, Boolean] = {
...
class MainGenericRunner {
  def errorFn(ex: System.Exception): Boolean = {
  ...
  def process(args: Array[String]): Boolean = {
    ...
    def runTarget(): Either[System.Exception, Boolean] = howToRun match {
      case AsObject =>
