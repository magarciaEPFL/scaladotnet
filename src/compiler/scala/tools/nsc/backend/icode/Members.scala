...
trait ReferenceEquality {
  override def GetHashCode = java.lang.System.identityHashCode(this)
...
trait Members {
  ...
  class Code(method: IMethod, name: String) {
    def this(method: IMethod) = this(method, _root_.java.lang.String.instancehelper_intern(method.symbol.decodedName.ToString))
  ...
  class Local(val sym: Symbol, val kind: TypeKind, val arg: Boolean) {
    ...
    override def GetHashCode = sym.GetHashCode
