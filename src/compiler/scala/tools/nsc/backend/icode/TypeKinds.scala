...
trait TypeKinds { self: ICodes =>
  ...
  sealed abstract class ValueTypeKind extends TypeKind {
    ...
    override def ToString = {
      _root_.java.lang.Object.instancehelper_getClass(this).getName stripSuffix "$" dropWhile (_ != '$') drop 1
    }
  }
  ...
  def toTypeKind(t: Type): TypeKind = t.normalize match {
    ...
    case norm => abort(
      "Unknown type: %s, %s [%s, %s] TypeRef? %s".format(
        t, norm, _root_.java.lang.Object.instancehelper_getClass(t), _root_.java.lang.Object.instancehelper_getClass(norm), t.isInstanceOf[TypeRef]
      )
    )
  }
