...
trait Primitives { self: ICodes =>
  ...
  class ComparisonOp {
    ...
    override def ToString(): String = this match {
      ...
      case CMP  => "CMP"
      case CMPG => "CMPG"
      case _ => throw new java.lang.RuntimeException("ComparisonOp unknown case")
    }
  }
  ...
  class TestOp {
    ...
    def negate(): TestOp = this match {
        ...
        case LE => GT
        case GT => LE
        case _  => throw new java.lang.RuntimeException("TestOp unknown case")
    }
  ...
  class ArithmeticOp {
    ...
    override def ToString(): String = this match {
      ...
      case REM => "REM"
      case NOT => "NOT"
      case _   => throw new java.lang.RuntimeException("ArithmeticOp unknown case")
    }
  }
  ...
  class ShiftOp {
    ...
    override def ToString(): String = this match {
      ...
      case ASR =>  "ASR"
      case LSR =>  "LSR"
      case _  => throw new java.lang.RuntimeException("ShitOp unknown case")
    }
  }
  ...
  class LogicalOp {
    ...
    override def ToString(): String = this match {
      ...
      case OR  => return "OR"
      case XOR => return "XOR"
      case _  => throw new java.lang.RuntimeException("LogicalOp unknown case")
    }
  }
