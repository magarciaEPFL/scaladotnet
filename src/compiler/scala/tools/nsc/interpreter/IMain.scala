...
class IMain(initialSettings: Settings, protected val out: JPrintWriter) extends Imports {
  ...
  protected def parentClassLoader: java.lang.ClassLoader =
    settings.explicitParentLoader.getOrElse( _root_.java.lang.Object.instancehelper_getClass(this).getClassLoader() )
  ...
  */
  ...
  def isParseable(line: String): Boolean = {
    beSilentDuring {
      ...
      catch { case x: java.lang.Exception =>    // crashed the compiler
  ...
  class ReadEvalPrint(lineId: Int) {
    ...
    class LineExceptional(ex: System.Exception) extends Exceptional(ex) {
    ...
    def bindError(t: System.Exception) = {
      ...
      withLastExceptionLock[String]({
        if (opt.richExes) {
          ...
          directBind[System.Exception]("lastException", unwrapped)
    ...
    def callEither(name: String, args: Any*): Either[System.Exception, AnyRef] =
      ...
      catch { case ex: System.Exception => Left(ex) }

    def callOpt(name: String, args: Any*): Option[AnyRef] =
      try Some(call(name, args: _*))
      catch { case ex: System.Exception => bindError(ex) ; None }

    class EvalException(msg: String, cause: System.Exception) extends RuntimeException(msg, cause) { }

    private def evalError(path: String, ex: System.Exception) =
      throw new EvalException("Failed to load '" + path + "': " + ex.Message, ex)
    ...
    var evalCaught: Option[System.Exception] = None
  ...
  class Request(val line: String, val trees: List[Tree]) {
    ...
    def fullFlatName(name: String) =
      lineRep.readPath + _root_.java.lang.String.instancehelper_replace(accessPath, '.', '$') + nme.NAME_JOIN_STRING + name
  ...
  def classOfTerm(id: String): Option[JClass] =
    valueOfTerm(id) map (_root_.java.lang.Object.instancehelper_getClass(_))
  ...
  def unqualifiedIds = visibleTermNames map (_.ToString) filterNot (_root_.java.lang.String.instancehelper_contains(_, "$")) sorted
...
object IMain {
  ...
  private def removeLineWrapper(s: String) = _root_.java.lang.String.instancehelper_replaceAll(s, """\$line\d+[./]\$(read|eval|print)[$.]""", "")
  private def removeIWPackages(s: String)  = _root_.java.lang.String.instancehelper_replaceAll(s, """\$(iw|read|eval|print)[$.]""", "")
